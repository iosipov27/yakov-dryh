...
export class YakovDryhCharacterSheet extends BaseSheet {
    ...
    handleRootClick(event) {
        ...
        const actionElement = target.closest("[data-yakov-dryh-action], [data-yakov-dryh-response-action], [data-yakov-dryh-response-add], [data-yakov-dryh-pool-edit-action], [data-yakov-dryh-pool-action]");
        if (!actionElement) {
            return;
        }
        ...
        const editField = actionElement.dataset.yakovDryhPoolEditField;
        const editAction = actionElement.dataset.yakovDryhPoolEditAction;
