...
import { createDisplayPips, createEditablePoolControls, createStressCardStyle, getEditablePoolTotal } from "./character-sheet-pool-helpers.js";
...
export function createCharacterSheetContext(input) {
    ...
    return {
        ...
        disciplineControls: createEditablePoolControls(disciplineValue, disciplineLabel, disciplineIsEditMode),
        disciplinePips: createDisplayPips(disciplineValue, getEditablePoolTotal(disciplineValue)),
        disciplineIsEditMode,
        disciplinePipTotal: getEditablePoolTotal(disciplineValue),
        exhaustionControls: createEditablePoolControls(exhaustionValue, exhaustionLabel, exhaustionIsEditMode),
        exhaustionPips: createDisplayPips(exhaustionValue, getEditablePoolTotal(exhaustionValue)),
        ...
        madnessControls: createEditablePoolControls(madnessValue, madnessLabel, madnessIsEditMode),
        madnessPips: createDisplayPips(madnessValue, getEditablePoolTotal(madnessValue)),
