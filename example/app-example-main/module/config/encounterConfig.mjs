    ...
    1: [
        {
            sort: 1,
            types: ['minion'],
            description: 'APP_EXAMPLE.CONFIG.AdversaryTypeCost.minion'
        },
        {
            sort: 2,
            types: ['social', 'support'],
            description: 'APP_EXAMPLE.CONFIG.AdversaryTypeCost.support'
        }
    ],
    2: [
        {
            ...
            description: 'APP_EXAMPLE.CONFIG.AdversaryTypeCost.standard'
        }
    ],
    3: [
        {
            sort: 1,
            types: ['leader'],
            description: 'APP_EXAMPLE.CONFIG.AdversaryTypeCost.leader'
        }
    ],
    4: [
        {
            sort: 1,
            types: ['bruiser'],
            description: 'APP_EXAMPLE.CONFIG.AdversaryTypeCost.bruiser'
        }
    ],
    5: [
        {
            sort: 1,
            types: ['solo'],
            description: 'APP_EXAMPLE.CONFIG.AdversaryTypeCost.solo'
        }
    ]
};
...
export const BPModifiers = {
    [-2]: {
        manySolos: {
            sort: 1,
            description: 'APP_EXAMPLE.CONFIG.BPModifiers.manySolos.description',
            automatic: true,
        ...
        increaseDamage: {
            sort: 2,
            description: 'APP_EXAMPLE.CONFIG.BPModifiers.increaseDamage.description',
            effectTargetTypes: ['adversary'],
            effects: [
                {
                    name: 'APP_EXAMPLE.CONFIG.BPModifiers.increaseDamage.effect.name',
                    description: 'APP_EXAMPLE.CONFIG.BPModifiers.increaseDamage.effect.description',
    ...
    [-1]: {
        lessDifficult: {
            sort: 2,
            description: 'APP_EXAMPLE.CONFIG.BPModifiers.lessDifficult.description'
        }
    },
    1: {
        lowerTier: {
            sort: 1,
            description: 'APP_EXAMPLE.CONFIG.BPModifiers.lowerTier.description',
            automatic: true,
        ...
        noToughies: {
            sort: 2,
            description: 'APP_EXAMPLE.CONFIG.BPModifiers.noToughies.description',
            automatic: true,
            conditional: (_combat, adversaries) => {
    ...
    2: {
        moreDangerous: {
            sort: 2,
            description: 'APP_EXAMPLE.CONFIG.BPModifiers.moreDangerous.description'
        }
    }
};
