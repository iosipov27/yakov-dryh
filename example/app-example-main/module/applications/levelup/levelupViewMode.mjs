...
export default class DhlevelUpViewMode extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    get title() {
        return game.i18n.format('APP_EXAMPLE.APPLICATIONS.Levelup.viewModeTitle', { actor: this.actor.name });
    }
    ...
    static PARTS = {
        main: { template: 'systems/app-example/templates/levelup/tabs/viewMode.hbs' }
    };
