        ...
        switch (partId) {
            case 'selections':
                ...
                context.viciousChoices = {
                    damage: game.i18n.localize('APP_EXAMPLE.APPLICATIONS.Levelup.selections.viciousDamage'),
                    range: game.i18n.localize('APP_EXAMPLE.APPLICATIONS.Levelup.selections.viciousRange')
                };
                ...
                context.advancements = {
                    ...
                    vicious: {
                        ...
                        range: advancement.vicious?.range
                            ? {
                                  old: game.i18n.localize(`APP_EXAMPLE.CONFIG.Range.${actorRange}.name`),
