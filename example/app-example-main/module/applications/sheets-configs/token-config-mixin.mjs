export default function DHTokenConfigMixin(Base) {
    class DHTokenConfigBase extends Base {
        ...
        static PARTS = {
            ...
            appearance: {
                template: 'systems/app-example/templates/sheets-settings/token-config/appearance.hbs',
                scrollable: ['']
            },
        ...
        async onTokenSizeChange(event) {
            ...
            if (tokenSizeDimensions) {
                ...
                tokenSizeDimensions.dataset.tooltip = disabled
                    ? game.i18n.localize('APP_EXAMPLE.APPLICATIONS.TokenConfig.actorSizeUsed')
                    : '';
