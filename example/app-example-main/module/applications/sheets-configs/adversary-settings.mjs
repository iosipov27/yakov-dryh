...
export default class DHAdversarySettings extends DHBaseActorSettings {
    ...
    static PARTS = {
        header: {
            id: 'header',
            template: 'systems/app-example/templates/sheets-settings/adversary-settings/header.hbs'
        },
        tabs: { template: 'systems/app-example/templates/sheets/global/tabs/tab-navigation.hbs' },
        details: {
            id: 'details',
            template: 'systems/app-example/templates/sheets-settings/adversary-settings/details.hbs'
        },
        attack: {
            id: 'attack',
            template: 'systems/app-example/templates/sheets-settings/adversary-settings/attack.hbs'
        },
        experiences: {
            id: 'experiences',
            template: 'systems/app-example/templates/sheets-settings/adversary-settings/experiences.hbs'
        },
        features: {
            id: 'features',
            template: 'systems/app-example/templates/sheets-settings/adversary-settings/features.hbs'
        }
    };
