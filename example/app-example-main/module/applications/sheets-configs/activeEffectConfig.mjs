...
export default class DhActiveEffectConfig extends foundry.applications.sheets.ActiveEffectConfig {
    ...
    static DEFAULT_OPTIONS = {
        classes: ['app-example', 'sheet', 'dh-style']
    };

    static PARTS = {
        header: { template: 'systems/app-example/templates/sheets/activeEffect/header.hbs' },
        tabs: { template: 'templates/generic/tab-navigation.hbs' },
        details: { template: 'systems/app-example/templates/sheets/activeEffect/details.hbs', scrollable: [''] },
        settings: { template: 'systems/app-example/templates/sheets/activeEffect/settings.hbs' },
        changes: {
            template: 'systems/app-example/templates/sheets/activeEffect/changes.hbs',
            scrollable: ['ol[data-changes]']
        },
        footer: { template: 'systems/app-example/templates/sheets/global/tabs/tab-form-footer.hbs' }
    };
    ...
    static TABS = {
        sheet: {
            tabs: [
                ...
                { id: 'settings', icon: 'fa-solid fa-bars', label: 'APP_EXAMPLE.GENERAL.Tabs.settings' },
        ...
        return Object.keys(game.system.api.models.actors).reduce((acc, key) => {
            ...
            const getTranslations = path => {
                if (path === 'resources.hope.max')
                    return {
                        label: game.i18n.localize('APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.maxHope.label'),
                        hint: ''
                    };
