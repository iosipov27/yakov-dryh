...
export default class DHCompanionSettings extends DHBaseActorSettings {
    ...
    static PARTS = {
        header: {
            id: 'header',
            template: 'systems/app-example/templates/sheets-settings/companion-settings/header.hbs'
        },
        tabs: { template: 'systems/app-example/templates/sheets/global/tabs/tab-navigation.hbs' },
        details: {
            id: 'details',
            template: 'systems/app-example/templates/sheets-settings/companion-settings/details.hbs'
        },
        experiences: {
            id: 'experiences',
            template: 'systems/app-example/templates/sheets-settings/companion-settings/experiences.hbs'
        },
        attack: {
            id: 'attack',
            template: 'systems/app-example/templates/sheets-settings/companion-settings/attack.hbs'
        }
    };
