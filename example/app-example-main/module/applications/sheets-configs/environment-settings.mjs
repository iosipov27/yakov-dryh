...
export default class DHEnvironmentSettings extends DHBaseActorSettings {
    ...
    static PARTS = {
        header: {
            id: 'header',
            template: 'systems/app-example/templates/sheets-settings/environment-settings/header.hbs'
        },
        tabs: { template: 'systems/app-example/templates/sheets/global/tabs/tab-navigation.hbs' },
        details: {
            id: 'details',
            template: 'systems/app-example/templates/sheets-settings/environment-settings/details.hbs'
        },
        features: {
            id: 'features',
            template: 'systems/app-example/templates/sheets-settings/environment-settings/features.hbs'
        },
        adversaries: {
            id: 'adversaries',
            template: 'systems/app-example/templates/sheets-settings/environment-settings/adversaries.hbs'
        }
    };
    ...
    static async #addCategory() {
        await this.actor.update({
            [`system.potentialAdversaries.${foundry.utils.randomID()}.label`]: game.i18n.localize(
                'APP_EXAMPLE.ACTORS.Environment.newAdversary'
            )
        });
    }
