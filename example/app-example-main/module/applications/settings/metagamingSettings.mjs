...
export default class DhMetagamingSettings extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        tag: 'form',
        id: 'app-example-metagaming-settings',
    ...
    static PARTS = {
        header: { template: 'systems/app-example/templates/settings/metagaming-settings/header.hbs' },
        general: { template: 'systems/app-example/templates/settings/metagaming-settings/general.hbs' },
        footer: { template: 'systems/app-example/templates/settings/metagaming-settings/footer.hbs' }
    };
