...
export default class DhCompanionSheet extends DHBaseActorSheet {
    ...
    static PARTS = {
        limited: {
            template: 'systems/app-example/templates/sheets/actors/companion/limited.hbs',
            scrollable: ['.limited-container']
        },
        header: { template: 'systems/app-example/templates/sheets/actors/companion/header.hbs' },
        details: { template: 'systems/app-example/templates/sheets/actors/companion/details.hbs' },
        effects: {
            template: 'systems/app-example/templates/sheets/actors/companion/effects.hbs',
    ...
    static async #actionRoll(event) {
        ...
        const config = {
            event,
            title: `${game.i18n.localize('APP_EXAMPLE.GENERAL.Roll.action')}: ${this.actor.name}`,
            headerTitle: `Companion ${game.i18n.localize('APP_EXAMPLE.GENERAL.Roll.action')}`,
            roll: {
