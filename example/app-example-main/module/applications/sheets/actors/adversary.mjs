...
export default class AdversarySheet extends DHBaseActorSheet {
    ...
    static PARTS = {
        limited: {
            template: 'systems/app-example/templates/sheets/actors/adversary/limited.hbs',
            scrollable: ['.limited-container']
        },
        sidebar: {
            template: 'systems/app-example/templates/sheets/actors/adversary/sidebar.hbs',
            scrollable: ['.shortcut-items-section']
        },
        header: { template: 'systems/app-example/templates/sheets/actors/adversary/header.hbs' },
        features: {
            template: 'systems/app-example/templates/sheets/actors/adversary/features.hbs',
            scrollable: ['.feature-section']
        },
        notes: {
            template: 'systems/app-example/templates/sheets/actors/adversary/notes.hbs'
        },
        effects: {
            template: 'systems/app-example/templates/sheets/actors/adversary/effects.hbs',
