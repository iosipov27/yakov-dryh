...
export default class DhpEnvironment extends DHBaseActorSheet {
    ...
    static PARTS = {
        limited: {
            template: 'systems/app-example/templates/sheets/actors/environment/limited.hbs',
            scrollable: ['.limited-container']
        },
        header: { template: 'systems/app-example/templates/sheets/actors/environment/header.hbs' },
        features: {
            template: 'systems/app-example/templates/sheets/actors/environment/features.hbs',
            scrollable: ['.feature-section']
        },
        potentialAdversaries: {
            template: 'systems/app-example/templates/sheets/actors/environment/potentialAdversaries.hbs',
            scrollable: ['.items-section']
        },
        notes: { template: 'systems/app-example/templates/sheets/actors/environment/notes.hbs' }
    };
