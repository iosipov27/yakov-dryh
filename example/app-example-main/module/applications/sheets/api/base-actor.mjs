...
export default class DHBaseActorSheet extends DHApplicationMixin(ActorSheetV2) {
    ...
    static async #sendExpToChat(_, button) {
        ...
        const systemData = {
            ...
            itemOrigin: {
                name: game.i18n.localize('APP_EXAMPLE.GENERAL.Experience.single')
            },
        ...
        const msg = {
            ...
            title: game.i18n.localize('APP_EXAMPLE.ACTIONS.Config.displayInChat'),
        ...
        if (item.system.metadata.isInventoryItem) {
            if (!this.document.testUserPermission(game.user, 'OWNER', { exact: true })) {
                return ui.notifications.error(
                    game.i18n.format('APP_EXAMPLE.UI.Notifications.lackingItemTransferPermission', {
                        user: game.user.name,
