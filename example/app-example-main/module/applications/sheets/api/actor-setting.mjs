...
/**
 * Base settings sheet for app-example actors.
...
export default class DHBaseActorSettings extends DHApplicationMixin(DocumentSheetV2) {
    ...
    static DEFAULT_OPTIONS = {
        ...
        window: {
            ...
            resizable: false,
            title: 'APP_EXAMPLE.GENERAL.Tabs.settings'
        },
        ...
        if (resourceConfig) {
            ...
            context.resources = relevant.map(key => {
                ...
                return {
                    ...
                    tooltip: key === 'hitPoints' ? game.i18n.localize('APP_EXAMPLE.UI.Tooltip.maxHPClassBound') : null,
                    field: new foundry.data.fields.NumberField({
                        initial: config.max,
                        integer: true,
                        label: game.i18n.format('APP_EXAMPLE.GENERAL.maxWithThing', {
