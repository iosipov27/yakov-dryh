...
export default class AncestrySheet extends DHHeritageSheet {
    ...
    /**@inheritdoc */
    static PARTS = {
        header: { template: 'systems/app-example/templates/sheets/items/ancestry/header.hbs' },
        ...super.PARTS,
        features: { template: 'systems/app-example/templates/sheets/items/ancestry/features.hbs' }
    };
