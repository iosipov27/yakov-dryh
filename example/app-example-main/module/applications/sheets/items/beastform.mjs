...
export default class BeastformSheet extends DHBaseItemSheet {
    ...
    /**@override */
    static PARTS = {
        header: { template: 'systems/app-example/templates/sheets/items/beastform/header.hbs' },
        tabs: { template: 'systems/app-example/templates/sheets/global/tabs/tab-navigation.hbs' },
        settings: { template: 'systems/app-example/templates/sheets/items/beastform/settings.hbs' },
        features: {
            template: 'systems/app-example/templates/sheets/global/tabs/tab-features.hbs',
            scrollable: ['.features']
        },
        advanced: { template: 'systems/app-example/templates/sheets/items/beastform/advanced.hbs' },
        effects: {
