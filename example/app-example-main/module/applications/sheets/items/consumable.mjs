...
export default class ConsumableSheet extends DHBaseItemSheet {
    ...
    /**@override */
    static PARTS = {
        header: { template: 'systems/app-example/templates/sheets/items/consumable/header.hbs' },
        ...
        settings: {
            template: 'systems/app-example/templates/sheets/items/consumable/settings.hbs',
            scrollable: ['.settings']
        },
        effects: {
