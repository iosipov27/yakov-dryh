...
export default class ClassSheet extends DHBaseItemSheet {
    ...
    /**@override */
    static PARTS = {
        header: { template: 'systems/app-example/templates/sheets/items/class/header.hbs' },
        ...
        features: {
            template: 'systems/app-example/templates/sheets/items/class/features.hbs',
            scrollable: ['.features']
        },
        settings: {
            template: 'systems/app-example/templates/sheets/items/class/settings.hbs',
            scrollable: ['.settings']
        },
        questions: {
            template: 'systems/app-example/templates/sheets/items/class/questions.hbs',
        ...
        if (itemType === 'subclass') {
            if (item.system.linkedClass) {
                return ui.notifications.warn(
                    game.i18n.format('APP_EXAMPLE.UI.Notifications.subclassAlreadyLinked', {
                        name: item.name,
