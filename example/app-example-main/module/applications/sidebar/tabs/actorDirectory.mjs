export default class DhActorDirectory extends foundry.applications.sidebar.tabs.ActorDirectory {
    ...
    static _entryPartial = 'systems/app-example/templates/ui/sidebar/actor-document-partial.hbs';
    ...
    _getEntryContextOptions() {
        ...
        options.push({
            name: 'APP_EXAMPLE.UI.Sidebar.actorDirectory.duplicateToNewTier',
            ...
            callback: async li => {
                ...
                select.append(
                    ...tiers.map(t => {
                        ...
                        option.value = t;
                        option.textContent = game.i18n.localize(`APP_EXAMPLE.GENERAL.Tiers.${t}`);
                        return option;
                    })
                );
                ...
                const tier = await foundry.applications.api.Dialog.input({
                    ...
                    window: { title: 'APP_EXAMPLE.UI.Sidebar.actorDirectory.pickTierTitle' },
                    content,
                    ok: {
