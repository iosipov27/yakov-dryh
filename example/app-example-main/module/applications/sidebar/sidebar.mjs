export default class DhSidebar extends foundry.applications.sidebar.Sidebar {
    ...
    static TABS = {
        ...
        appExampleMenu: {
            tooltip: 'APP_EXAMPLE.UI.Sidebar.appExampleMenu.title',
            img: 'systems/app-example/assets/logos/FoundryBorneLogoWhite.svg',
            gmOnly: true
        },
        settings: {
    ...
    static PARTS = {
        tabs: {
            id: 'tabs',
            template: 'systems/app-example/templates/sidebar/tabs.hbs'
        }
    };
