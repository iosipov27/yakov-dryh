...
export default class CharacterResetDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    constructor(actor, options = {}) {
        ...
        this.data = {
            ...
            optional: {
                portrait: { keep: true, label: 'APP_EXAMPLE.GENERAL.portrait' },
                name: { keep: true, label: 'Name' },
                biography: { keep: true, label: 'APP_EXAMPLE.GENERAL.Tabs.biography' },
                inventory: { keep: true, label: 'APP_EXAMPLE.GENERAL.inventory' }
            }
        };
    }
    ...
    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['app-example', 'dialog', 'dh-style', 'views', 'character-reset'],
        window: {
            icon: 'fa-solid fa-arrow-rotate-left',
            title: 'APP_EXAMPLE.APPLICATIONS.CharacterReset.title'
        },
        actions: {
    ...
    static PARTS = {
        resourceDice: {
            id: 'resourceDice',
            template: 'systems/app-example/templates/dialogs/characterReset.hbs'
        }
    };
