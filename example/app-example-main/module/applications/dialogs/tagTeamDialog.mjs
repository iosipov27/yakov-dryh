...
export default class TagTeamDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    get title() {
        return game.i18n.localize('APP_EXAMPLE.APPLICATIONS.TagTeamSelect.title');
    }

    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['app-example', 'views', 'dh-style', 'dialog', 'tag-team-dialog'],
    ...
    static PARTS = {
        application: {
            id: 'tag-team-dialog',
            template: 'systems/app-example/templates/dialogs/tagTeamDialog.hbs'
        }
    };
    ...
    static async #createTagTeam() {
        ...
        if (this.data.initiator.cost) {
            ...
            if (initiator.system.resources.hope.value < this.data.initiator.cost) {
                return ui.notifications.warn(
                    game.i18n.localize('APP_EXAMPLE.APPLICATIONS.TagTeamSelect.insufficientHope')
                );
            }
        }
        ...
        systemData.title = game.i18n.localize('APP_EXAMPLE.APPLICATIONS.TagTeamSelect.chatMessageRollTitle');
        const cls = getDocumentClass('ChatMessage'),
            msgData = {
                type: 'dualityRoll',
                user: game.user.id,
                title: game.i18n.localize('APP_EXAMPLE.APPLICATIONS.TagTeamSelect.title'),
