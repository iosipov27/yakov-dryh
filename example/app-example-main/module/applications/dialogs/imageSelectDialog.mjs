...
export default class ImageSelectDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['app-example', 'dialog', 'dh-style', 'image-select'],
        position: {
            width: 612,
            height: 'auto'
        },
    ...
    static PARTS = {
        main: {
            template: 'systems/app-example/templates/dialogs/image-select/main.hbs',
            scrollable: ['.images-container']
        },
        footer: { template: 'systems/app-example/templates/dialogs/image-select/footer.hbs' }
    };
