...
export default class MulticlassChoiceDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    get title() {
        return game.i18n.format('APP_EXAMPLE.APPLICATIONS.MulticlassChoice.title', { actor: this.actor.name });
    }

    static DEFAULT_OPTIONS = {
        classes: ['app-example', 'dh-style', 'dialog', 'views', 'multiclass-choice'],
    ...
    static PARTS = {
        application: {
            ...
            template: 'systems/app-example/templates/dialogs/multiclassChoice.hbs'
        }
    };
