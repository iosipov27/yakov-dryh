...
export default class D20RollDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        tag: 'form',
        // id: 'roll-selection',
        classes: ['app-example', 'dialog', 'dh-style', 'views', 'roll-selection'],
        position: {
            width: 'auto'
        },
        window: {
    ...
    static PARTS = {
        header: {
            id: 'header',
            template: 'systems/app-example/templates/dialogs/dice-roll/header.hbs'
        },
        rollSelection: {
            id: 'rollSelection',
            template: 'systems/app-example/templates/dialogs/dice-roll/rollSelection.hbs'
        }
    };
    ...
    static updateRollConfiguration(event, _, formData) {
        ...
        if (rest.hasOwnProperty('trait')) {
            ...
            if (!this.config.source.item)
                this.config.title = game.i18n.format('APP_EXAMPLE.UI.Chat.dualityRoll.abilityCheckTitle', {
