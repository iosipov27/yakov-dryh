...
export default class CompendiumBrowserSettings extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        tag: 'div',
        classes: ['app-example', 'dialog', 'dh-style', 'views', 'compendium-brower-settings'],
        window: {
            icon: 'fa-solid fa-book',
            title: 'APP_EXAMPLE.APPLICATIONS.CompendiumBrowserSettings.title'
        },
        position: {
            width: 500
        },
    ...
    static PARTS = {
        packs: {
            id: 'packs',
            template: 'systems/app-example/templates/dialogs/compendiumBrowserSettingsDialog/packs.hbs'
        },
        footer: { template: 'systems/app-example/templates/dialogs/compendiumBrowserSettingsDialog/footer.hbs' }
    };
    ...
    async _prepareContext(_options) {
        ...
        context.typePackCollections = game.packs.reduce((acc, pack) => {
            ...
            const sourceLabel =
                ...
                (isWorldPack
                    ? game.i18n.localize('APP_EXAMPLE.APPLICATIONS.CompendiumBrowserSettings.worldCompendiums')
                    : game.system.title);
