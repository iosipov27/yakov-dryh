...
export default class RiskItAllDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    get title() {
        return game.i18n.format('APP_EXAMPLE.APPLICATIONS.RiskItAllDialog.title', { name: this.actor.name });
    }

    static DEFAULT_OPTIONS = {
        classes: ['app-example', 'dh-style', 'dialog', 'views', 'risk-it-all'],
    ...
    static PARTS = {
        application: {
            id: 'risk-it-all',
            template: 'systems/app-example/templates/dialogs/riskItAllDialog.hbs'
        }
    };
