...
export default class ResourceDiceDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['app-example', 'dialog', 'dh-style', 'views', 'resource-dice'],
        window: {
    ...
    static PARTS = {
        resourceDice: {
            id: 'resourceDice',
            template: 'systems/app-example/templates/dialogs/dice-roll/resourceDice.hbs'
        }
    };

    get title() {
        return game.i18n.format('APP_EXAMPLE.APPLICATIONS.ResourceDice.title', { name: this.item.name });
    }
    ...
    static async rerollDice() {
        ...
        const msg = {
            ...
            content: await foundry.applications.handlebars.renderTemplate(
                'systems/app-example/templates/ui/chat/resource-roll.hbs',
                {
