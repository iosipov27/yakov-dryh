...
export default class GroupRollDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['app-example', 'views', 'dh-style', 'dialog', 'group-roll'],
        position: { width: 'auto', height: 'auto' },
        window: {
            title: 'APP_EXAMPLE.UI.Chat.groupRoll.title'
        },
        actions: {
    ...
    static PARTS = {
        application: {
            id: 'group-roll',
            template: 'systems/app-example/templates/dialogs/group-roll/group-roll.hbs'
        }
    };
    ...
    static async #roll() {
        ...
        const msg = {
            ...
            title: game.i18n.localize('APP_EXAMPLE.UI.Chat.groupRoll.title'),
            system: systemData,
