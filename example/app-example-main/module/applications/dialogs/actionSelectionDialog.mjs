...
export default class ActionSelectionDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        classes: ['app-example', 'dh-style', 'dialog'],
        actions: {
    ...
    static PARTS = {
        actions: {
            template: 'systems/app-example/templates/dialogs/actionSelect.hbs'
        }
    };
    ...
    /** @override */
    get title() {
        return game.i18n.localize('APP_EXAMPLE.CONFIG.SelectAction.selectAction');
    }
