...
export default class AttributionDialog extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    get title() {
        return game.i18n.localize('APP_EXAMPLE.APPLICATIONS.Attribution.title');
    }

    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['app-example', 'dh-style', 'dialog', 'views', 'attribution'],
    ...
    static PARTS = {
        main: { template: 'systems/app-example/templates/dialogs/attribution.hbs' }
    };
