...
export default class DhEffectsDisplay extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        id: 'effects-display',
        tag: 'div',
        classes: ['app-example', 'dh-style', 'effects-display'],
        window: {
            frame: false,
            positioned: false,
            resizable: false,
    ...
    static PARTS = {
        resources: {
            root: true,
            template: 'systems/app-example/templates/ui/effects-display.hbs'
        }
    };

    get element() {
        return document.body.querySelector('.app-example.dh-style.effects-display');
    }
