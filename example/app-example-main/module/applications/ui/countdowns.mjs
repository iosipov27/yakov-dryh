...
export default class DhCountdowns extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        id: 'countdowns',
        tag: 'div',
        classes: ['app-example', 'dh-style', 'countdowns', 'faded-ui'],
        window: {
            icon: 'fa-solid fa-clock-rotate-left',
            frame: true,
            title: 'APP_EXAMPLE.UI.Countdowns.title',
            positioned: false,
            resizable: false,
            minimizable: false
        },
    ...
    static PARTS = {
        resources: {
            root: true,
            template: 'systems/app-example/templates/ui/countdowns.hbs'
        }
    };

    get element() {
        return document.body.querySelector('.app-example.dh-style.countdowns');
    }
    ...
    async _renderFrame(options) {
        ...
        if (game.user.isGM) {
            const editTooltip = game.i18n.localize('APP_EXAMPLE.APPLICATIONS.CountdownEdit.editTitle');
        ...
        const minimizeTooltip = game.i18n.localize('APP_EXAMPLE.UI.Countdowns.toggleIconMode');
