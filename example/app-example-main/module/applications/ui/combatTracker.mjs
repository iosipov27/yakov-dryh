...
export default class DhCombatTracker extends foundry.applications.sidebar.tabs.CombatTracker {
    ...
    static PARTS = {
        header: {
            template: 'systems/app-example/templates/ui/combatTracker/combatTrackerHeader.hbs'
        },
        tracker: {
            template: 'systems/app-example/templates/ui/combatTracker/combatTracker.hbs'
        },
        footer: {
            template: 'systems/app-example/templates/ui/combatTracker/combatTrackerFooter.hbs'
        }
    };
