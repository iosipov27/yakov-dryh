...
export default class DhTooltipManager extends foundry.helpers.interaction.TooltipManager {
    ...
    async activate(element, options = {}) {
        ...
        if (element.dataset.tooltip === '#effect-display#') {
            ...
            html = await foundry.applications.handlebars.renderTemplate(
                `systems/app-example/templates/ui/tooltip/effect-display.hbs`,
                {
                    effect
                }
            );
        ...
        if (element.dataset.tooltip?.startsWith('#item#')) {
            ...
            if (item) {
                ...
                html = await foundry.applications.handlebars.renderTemplate(
                    `systems/app-example/templates/ui/tooltip/${type}.hbs`,
                    {
                        item: item,
            ...
            if (attack) {
                ...
                html = await foundry.applications.handlebars.renderTemplate(
                    `systems/app-example/templates/ui/tooltip/attack.hbs`,
                    {
                        attack: attack,
            ...
            if (shortRest || longRest) {
                ...
                html = await foundry.applications.handlebars.renderTemplate(
                    `systems/app-example/templates/ui/tooltip/downtime.hbs`,
                    {
                        move: move,
                        description: description
                    }
            ...
            if (isAdvantage || isDisadvantage) {
                ...
                if (actor) {
                    html = await foundry.applications.handlebars.renderTemplate(
                        `systems/app-example/templates/ui/tooltip/advantage.hbs`,
                        {
            ...
            if (deathMove) {
                ...
                html = await foundry.applications.handlebars.renderTemplate(
                    `systems/app-example/templates/ui/tooltip/death-move.hbs`,
                    {
    ...
    async getBattlepointHTML(combatId) {
        ...
        return await foundry.applications.handlebars.renderTemplate(
            `systems/app-example/templates/ui/tooltip/battlepoints.hbs`,
            {
                combatId: combat.id,
                nrCharacters,
                currentBP,
