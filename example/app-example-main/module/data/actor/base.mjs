    ...
    damageReduction: new fields.SchemaField({
        thresholdImmunities: new fields.SchemaField({
            minor: new fields.BooleanField({
                initial: false,
                label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.thresholdImmunities.minor.label',
                hint: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.thresholdImmunities.minor.hint'
            })
        }),
        reduceSeverity: new fields.SchemaField({
            magical: new fields.NumberField({
                initial: 0,
                min: 0,
                label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.reduceSeverity.magical.label',
                hint: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.reduceSeverity.magical.hint'
            }),
            physical: new fields.NumberField({
                initial: 0,
                min: 0,
                label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.reduceSeverity.physical.label',
                hint: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.reduceSeverity.physical.hint'
            })
        }),
    ...
    attack: new fields.SchemaField({
        ...
        damage: new fields.SchemaField({
            hpDamageMultiplier: new fields.NumberField({
                ...
                nullable: false,
                initial: 1,
                label: 'APP_EXAMPLE.GENERAL.Attack.hpDamageMultiplier.label',
                hint: 'APP_EXAMPLE.GENERAL.Attack.hpDamageMultiplier.hint'
            }),
            hpDamageTakenMultiplier: new fields.NumberField({
                required: true,
                nullable: false,
                initial: 1,
                label: 'APP_EXAMPLE.GENERAL.Attack.hpDamageTakenMultiplier.label',
                hint: 'APP_EXAMPLE.GENERAL.Attack.hpDamageTakenMultiplier.hint'
            }),
        ...
        if (this.metadata.hasResistances)
            schema.resistance = new fields.SchemaField({
                physical: resistanceField(
                    'APP_EXAMPLE.GENERAL.DamageResistance.physicalResistance',
                    'APP_EXAMPLE.GENERAL.DamageResistance.physicalImmunity',
                    'APP_EXAMPLE.GENERAL.DamageResistance.physicalReduction'
                ),
                magical: resistanceField(
                    'APP_EXAMPLE.GENERAL.DamageResistance.magicalResistance',
                    'APP_EXAMPLE.GENERAL.DamageResistance.magicalImmunity',
                    'APP_EXAMPLE.GENERAL.DamageResistance.magicalReduction'
                )
            });
