...
export default class DhEnvironment extends BaseDataActor {
    ...
    /**@override */
    static LOCALIZATION_PREFIXES = ['APP_EXAMPLE.ACTORS.Environment'];
    ...
    /**@inheritdoc */
    static DEFAULT_ICON = 'systems/app-example/assets/icons/documents/actors/forest.svg';
    ...
    _onDelete(options, userId) {
        ...
        for (const scene of this.scenes) {
            if (game.user.isActiveGM) {
                const newSceneEnvironments = scene.flags["app-example"].sceneEnvironments.filter(
                    x => x !== this.parent.uuid
                );
                scene.update({ 'flags.app-example.sceneEnvironments': newSceneEnvironments }).then(() => {
