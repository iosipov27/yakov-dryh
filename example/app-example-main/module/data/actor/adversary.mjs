...
export default class DhpAdversary extends DhCreature {
    static LOCALIZATION_PREFIXES = ['APP_EXAMPLE.ACTORS.Adversary'];
    ...
    static defineSchema() {
        ...
        return {
            ...
            hordeHp: new fields.NumberField({
                ...
                initial: 1,
                integer: true,
                label: 'APP_EXAMPLE.GENERAL.hordeHp'
            }),
            criticalThreshold: new fields.NumberField({
                ...
                max: 20,
                initial: 20,
                label: 'APP_EXAMPLE.ACTIONS.Settings.criticalThreshold'
            }),
    ...
    /**@inheritdoc */
    static DEFAULT_ICON = 'systems/app-example/assets/icons/documents/actors/dragon-head.svg';
                ...
                if (changes.system.type === CONFIG.DH.ACTOR.adversaryTypes.horde.id) {
                    if (!existingHordeEffect)
                        this.parent.createEmbeddedDocuments('ActiveEffect', [
                            {
                                type: 'horde',
                                name: game.i18n.localize('APP_EXAMPLE.CONFIG.AdversaryType.horde.label'),
    ...
    _getTags() {
        const tags = [
            game.i18n.localize(`APP_EXAMPLE.GENERAL.Tiers.${this.tier}`),
            `${game.i18n.localize(`APP_EXAMPLE.CONFIG.AdversaryType.${this.type}.label`)}`,
            `${game.i18n.localize('APP_EXAMPLE.GENERAL.difficulty')}: ${this.difficulty}`
        ];
        return tags;
    }
