...
export default class DhCharacter extends DhCreature {
    /**@override */
    static LOCALIZATION_PREFIXES = ['APP_EXAMPLE.ACTORS.Character'];
    ...
    static defineSchema() {
        ...
        return {
            ...
            traits: new fields.SchemaField({
                agility: attributeField('APP_EXAMPLE.CONFIG.Traits.agility.name'),
                strength: attributeField('APP_EXAMPLE.CONFIG.Traits.strength.name'),
                finesse: attributeField('APP_EXAMPLE.CONFIG.Traits.finesse.name'),
                instinct: attributeField('APP_EXAMPLE.CONFIG.Traits.instinct.name'),
                presence: attributeField('APP_EXAMPLE.CONFIG.Traits.presence.name'),
                knowledge: attributeField('APP_EXAMPLE.CONFIG.Traits.knowledge.name')
            }),
            proficiency: new fields.NumberField({
                initial: 1,
                integer: true,
                label: 'APP_EXAMPLE.GENERAL.proficiency'
            }),
            evasion: new fields.NumberField({ initial: 0, integer: true, label: 'APP_EXAMPLE.GENERAL.evasion' }),
            armorScore: new fields.NumberField({ integer: true, initial: 0, label: 'APP_EXAMPLE.GENERAL.armorScore' }),
            damageThresholds: new fields.SchemaField({
                severe: new fields.NumberField({
                    integer: true,
                    initial: 0,
                    label: 'APP_EXAMPLE.GENERAL.DamageThresholds.severeThreshold'
                }),
                major: new fields.NumberField({
                    integer: true,
                    initial: 0,
                    label: 'APP_EXAMPLE.GENERAL.DamageThresholds.majorThreshold'
                })
            }),
            ...
            scars: new fields.NumberField({ initial: 0, integer: true, label: 'APP_EXAMPLE.GENERAL.scars' }),
            ...
            attack: new ActionField({
                initial: {
                    name: 'APP_EXAMPLE.GENERAL.unarmedAttack',
            ...
            bonuses: new fields.SchemaField({
                roll: new fields.SchemaField({
                    attack: bonusField('APP_EXAMPLE.GENERAL.Roll.attack'),
                    spellcast: bonusField('APP_EXAMPLE.GENERAL.Roll.spellcast'),
                    trait: bonusField('APP_EXAMPLE.GENERAL.Roll.trait'),
                    action: bonusField('APP_EXAMPLE.GENERAL.Roll.action'),
                    reaction: bonusField('APP_EXAMPLE.GENERAL.Roll.reaction'),
                    primaryWeapon: bonusField('APP_EXAMPLE.GENERAL.Roll.primaryWeaponAttack'),
                    secondaryWeapon: bonusField('APP_EXAMPLE.GENERAL.Roll.secondaryWeaponAttack')
                }),
                damage: new fields.SchemaField({
                    ...
                    primaryWeapon: bonusField('APP_EXAMPLE.GENERAL.Damage.primaryWeapon'),
                    secondaryWeapon: bonusField('APP_EXAMPLE.GENERAL.Damage.secondaryWeapon')
                }),
                healing: bonusField('APP_EXAMPLE.GENERAL.Healing.healingAmount'),
                range: new fields.SchemaField({
                    weapon: new fields.NumberField({
                        integer: true,
                        initial: 0,
                        label: 'APP_EXAMPLE.GENERAL.Range.weapon'
                    }),
                    spell: new fields.NumberField({
                        integer: true,
                        initial: 0,
                        label: 'APP_EXAMPLE.GENERAL.Range.spell'
                    }),
                    other: new fields.NumberField({
                        integer: true,
                        initial: 0,
                        label: 'APP_EXAMPLE.GENERAL.Range.other'
                    })
                }),
                rally: new fields.ArrayField(new fields.StringField(), {
                    label: 'APP_EXAMPLE.CLASS.Feature.rallyDice'
                }),
                rest: new fields.SchemaField({
                    shortRest: new fields.SchemaField({
                        shortMoves: new fields.NumberField({
                            ...
                            min: 0,
                            initial: 0,
                            label: 'APP_EXAMPLE.GENERAL.Bonuses.rest.shortRest.shortRestMoves.label',
                            hint: 'APP_EXAMPLE.GENERAL.Bonuses.rest.shortRest.shortRestMoves.hint'
                        }),
                        longMoves: new fields.NumberField({
                            ...
                            min: 0,
                            initial: 0,
                            label: 'APP_EXAMPLE.GENERAL.Bonuses.rest.shortRest.longRestMoves.label',
                            hint: 'APP_EXAMPLE.GENERAL.Bonuses.rest.shortRest.longRestMoves.hint'
                        })
                    }),
                    longRest: new fields.SchemaField({
                        shortMoves: new fields.NumberField({
                            ...
                            min: 0,
                            initial: 0,
                            label: 'APP_EXAMPLE.GENERAL.Bonuses.rest.longRest.shortRestMoves.label',
                            hint: 'APP_EXAMPLE.GENERAL.Bonuses.rest.longRest.shortRestMoves.hint'
                        }),
                        longMoves: new fields.NumberField({
                            required: true,
                            integer: true,
                            min: 0,
                            initial: 0,
                            label: 'APP_EXAMPLE.GENERAL.Bonuses.rest.longRest.longRestMoves.label',
                            hint: 'APP_EXAMPLE.GENERAL.Bonuses.rest.longRest.longRestMoves.hint'
                        })
                    })
                }),
                maxLoadout: new fields.NumberField({
                    integer: true,
                    initial: 0,
                    label: 'APP_EXAMPLE.GENERAL.Bonuses.maxLoadout.label'
                })
            }),
            ...
            rules: new fields.SchemaField({
                ...commonActorRules({
                    damageReduction: {
                        magical: new fields.BooleanField({
                            initial: false,
                            label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.magical.label',
                            hint: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.magical.hint'
                        }),
                        physical: new fields.BooleanField({
                            initial: false,
                            label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.physical.label',
                            hint: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.physical.hint'
                        }),
                        maxArmorMarked: new fields.SchemaField({
                            value: new fields.NumberField({
                                ...
                                integer: true,
                                initial: 1,
                                label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.maxArmorMarkedBonus'
                            }),
                            stressExtra: new fields.NumberField({
                                required: true,
                                integer: true,
                                initial: 0,
                                label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.maxArmorMarkedStress.label',
                                hint: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.maxArmorMarkedStress.hint'
                            })
                        }),
                        stressDamageReduction: new fields.SchemaField({
                            severe: stressDamageReductionRule(
                                'APP_EXAMPLE.GENERAL.Rules.damageReduction.stress.severe'
                            ),
                            major: stressDamageReductionRule('APP_EXAMPLE.GENERAL.Rules.damageReduction.stress.major'),
                            minor: stressDamageReductionRule('APP_EXAMPLE.GENERAL.Rules.damageReduction.stress.minor'),
                            any: stressDamageReductionRule('APP_EXAMPLE.GENERAL.Rules.damageReduction.stress.any')
                        }),
                        increasePerArmorMark: new fields.NumberField({
                            integer: true,
                            initial: 1,
                            label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.increasePerArmorMark.label',
                            hint: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.increasePerArmorMark.hint'
                        }),
                        disabledArmor: new fields.BooleanField({
                            intial: false,
                            label: 'APP_EXAMPLE.GENERAL.Rules.damageReduction.disabledArmor.label'
                        })
                    },
                    attack: {
                        damage: {
                            diceIndex: new fields.NumberField({
                                ...
                                max: 5,
                                initial: 0,
                                label: 'APP_EXAMPLE.GENERAL.Rules.attack.damage.dice.label',
                                hint: 'APP_EXAMPLE.GENERAL.Rules.attack.damage.dice.hint'
                            }),
                            bonus: new fields.NumberField({
                                required: true,
                                initial: 0,
                                min: 0,
                                label: 'APP_EXAMPLE.GENERAL.Rules.attack.damage.bonus.label'
                            })
                        },
                        roll: new fields.SchemaField({
                            trait: new fields.StringField({
                                ...
                                nullable: true,
                                initial: null,
                                label: 'APP_EXAMPLE.GENERAL.Rules.attack.roll.trait.label'
                            })
                        })
                    }
                }),
                dualityRoll: new fields.SchemaField({
                    defaultHopeDice: new fields.NumberField({
                        ...
                        initial: 12,
                        label: 'APP_EXAMPLE.ACTORS.Character.defaultHopeDice'
                    }),
                    defaultFearDice: new fields.NumberField({
                        ...
                        choices: CONFIG.DH.GENERAL.dieFaces,
                        initial: 12,
                        label: 'APP_EXAMPLE.ACTORS.Character.defaultFearDice'
                    })
                }),
                burden: new fields.SchemaField({
                    ignore: new fields.BooleanField({ label: 'APP_EXAMPLE.ACTORS.Character.burden.ignore.label' })
                }),
                roll: new fields.SchemaField({
                    guaranteedCritical: new fields.BooleanField({
                        label: 'APP_EXAMPLE.ACTORS.Character.roll.guaranteedCritical.label',
                        hint: 'APP_EXAMPLE.ACTORS.Character.roll.guaranteedCritical.hint'
                    })
                })
            })
        };
    ...
    get usedUnarmed() {
        ...
        if (this.activeBeastform) {
            attack.name = 'APP_EXAMPLE.ITEMS.Beastform.attackName';
    ...
    get sheetLists() {
        ...
        return {
            ...
            companionFeatures: {
                title: game.i18n.localize('APP_EXAMPLE.ACTORS.Character.companionFeatures'),
                type: 'companion',
                values: companionFeatures
            },
            features: { title: game.i18n.localize('APP_EXAMPLE.GENERAL.features'), type: 'feature', values: features }
        };
    }
    ...
    prepareDerivedData() {
        ...
        this.resources.armor = {
            label: 'APP_EXAMPLE.GENERAL.armor',
