...
export default class DHAncestry extends BaseDataItem {
    ...
    /**@override */
    static DEFAULT_ICON = 'systems/app-example/assets/icons/documents/items/family-tree.svg';
    ...
    async getDescriptionData() {
        ...
        const suffix = await foundry.applications.handlebars.renderTemplate(
            'systems/app-example/templates/sheets/items/description.hbs',
            { label: 'APP_EXAMPLE.ITEMS.Ancestry.featuresLabel', features }
        );
