...
export default class DHArmor extends AttachableItem {
    ...
    /**@override */
    static DEFAULT_ICON = 'systems/app-example/assets/icons/documents/items/chest-armor.svg';
    ...
    async getDescriptionData() {
        ...
        const prefix = await foundry.applications.handlebars.renderTemplate(
            'systems/app-example/templates/sheets/items/armor/description.hbs',
    ...
    _getTags() {
        const tags = [
            `${game.i18n.localize('APP_EXAMPLE.ITEMS.Armor.baseScore')}: ${this.baseScore}`,
            `${game.i18n.localize('APP_EXAMPLE.ITEMS.Armor.baseThresholds.base')}: ${this.baseThresholds.major} / ${this.baseThresholds.severe}`
        ];
    ...
    _getLabels() {
        const labels = [];
        if (this.baseScore)
            labels.push(`${game.i18n.localize('APP_EXAMPLE.ITEMS.Armor.baseScore')}: ${this.baseScore}`);
        return labels;
    }
