...
export function ActionMixin(Base) {
    class Action extends Base {
        static metadata = Object.freeze({
            name: 'Action',
            label: 'APP_EXAMPLE.GENERAL.Action.single',
        ...
        async toChat(origin) {
            ...
            const systemData = {
                title: game.i18n.localize('APP_EXAMPLE.CONFIG.FeatureForm.action'),
                origin: origin,
                action: {
                    name: this.name,
            ...
            const msg = {
                ...
                title: game.i18n.localize('APP_EXAMPLE.UI.Chat.action.title'),
                system: systemData,
                content: await foundry.applications.handlebars.renderTemplate(
