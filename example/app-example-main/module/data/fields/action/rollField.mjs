        ...
        return {
            ...
            diceRolling: new fields.SchemaField({
                multiplier: new fields.StringField({
                    ...
                    initial: 'prof',
                    label: 'APP_EXAMPLE.ACTIONS.RollField.diceRolling.multiplier',
                    nullable: false,
                    required: true
                }),
                flatMultiplier: new fields.NumberField({
                    nullable: true,
                    initial: 1,
                    label: 'APP_EXAMPLE.ACTIONS.RollField.diceRolling.flatMultiplier'
                }),
                dice: new fields.StringField({
                    choices: CONFIG.DH.GENERAL.diceTypes,
                    initial: CONFIG.DH.GENERAL.diceTypes.d6,
                    label: 'APP_EXAMPLE.ACTIONS.RollField.diceRolling.dice',
                    nullable: false,
                    required: true
                }),
                compare: new fields.StringField({
                    ...
                    nullable: true,
                    initial: null,
                    label: 'APP_EXAMPLE.ACTIONS.RollField.diceRolling.compare'
                }),
                treshold: new fields.NumberField({
                    integer: true,
                    nullable: true,
                    initial: null,
                    label: 'APP_EXAMPLE.ACTIONS.RollField.diceRolling.threshold'
                })
            }),
