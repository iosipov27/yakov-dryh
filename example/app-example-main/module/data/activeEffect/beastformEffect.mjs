        ...
        if (this.parent.parent.type === 'character') {
            ...
            const updateToken = token => {
                ...
                return {
                    ...
                    'texture': {
                        enabled: this.characterTokenData.usesDynamicToken,
                        src: token.flags["app-example"]?.beastformTokenImg ?? this.characterTokenData.tokenImg,
                        scaleX: this.characterTokenData.tokenSize.scale,
                        scaleY: this.characterTokenData.tokenSize.scale
                    },
                    'ring': {
                        subject: {
                            texture:
                                token.flags["app-example"]?.beastformSubjectTexture ?? this.characterTokenData.tokenRingImg
                        }
                    },
                    'flags.app-example': { '-=beastformTokenImg': null, '-=beastformSubjectTexture': null }
                };
            };
