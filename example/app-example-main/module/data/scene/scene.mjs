        ...
        return {
            rangeMeasurement: new fields.SchemaField({
                setting: new fields.StringField({
                    ...
                    label: 'APP_EXAMPLE.SETTINGS.Scene.FIELDS.rangeMeasurement.setting.label'
                }),
                melee: new fields.NumberField({ integer: true, label: 'APP_EXAMPLE.CONFIG.Range.melee.name' }),
                veryClose: new fields.NumberField({ integer: true, label: 'APP_EXAMPLE.CONFIG.Range.veryClose.name' }),
                close: new fields.NumberField({ integer: true, label: 'APP_EXAMPLE.CONFIG.Range.close.name' }),
                far: new fields.NumberField({ integer: true, label: 'APP_EXAMPLE.CONFIG.Range.far.name' })
            }),
