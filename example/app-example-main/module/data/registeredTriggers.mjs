export default class RegisteredTriggers extends Map {
    ...
    unregisterSceneTriggers(scene) {
        this.unregisterSceneEnvironmentTriggers(scene.flags["app-example"]);
    ...
    registerSceneTriggers(scene) {
        this.registerSceneEnvironmentTriggers(scene.flags["app-example"]);
                ...
                for (const command of commands) {
                    try {
                        if (CONFIG.debug.triggers) {
                            ...
                            console.log(
                                game.i18n.format('APP_EXAMPLE.UI.ConsoleLogs.triggerRun', {
                        ...
                        ui.notifications.error(
                            game.i18n.format('APP_EXAMPLE.CONFIG.Triggers.triggerError', {
                                trigger: triggerName,
