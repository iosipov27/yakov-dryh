    ...
    static defineSchema() {
        ...
        return {
            name: new fields.StringField({
                required: true,
                label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.name.label'
            }),
            ...
            progress: new fields.SchemaField({
                current: new fields.NumberField({
                    ...
                    integer: true,
                    initial: 1,
                    label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.progress.current.label'
                }),
                max: new fields.NumberField({
                    required: true,
                    integer: true,
                    initial: 1,
                    label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.progress.max.label'
                }),
                type: new fields.SchemaField({
                    ...
                    label: new fields.StringField({
                        label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.progress.type.label.label'
                    })
                })
            })
        };
...
export class DhCountdown extends foundry.abstract.DataModel {
        ...
        return {
            ...
            progress: new fields.SchemaField({
                ...
                start: new fields.NumberField({
                    ...
                    integer: true,
                    initial: 1,
                    label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.progress.start.label',
                    deterministic: false
                }),
                startFormula: new FormulaField({
                    label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.progress.startFormula.label',
                    deterministic: false
                }),
                looping: new fields.StringField({
                    ...
                    label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.progress.looping.label'
                }),
                type: new fields.StringField({
                    required: true,
                    choices: CONFIG.DH.GENERAL.countdownProgressionTypes,
                    initial: CONFIG.DH.GENERAL.countdownProgressionTypes.custom.id,
                    label: 'APP_EXAMPLE.APPLICATIONS.Countdown.FIELDS.countdowns.element.type.label'
                })
            })
        };
    }
    ...
    static defaultCountdown(type, playerHidden) {
        ...
        return {
            ...
            name: game.i18n.localize('APP_EXAMPLE.APPLICATIONS.Countdown.newCountdown'),
