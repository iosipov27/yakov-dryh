...
export default class DHBaseAction extends ActionMixin(foundry.abstract.DataModel) {
    ...
    static defineSchema() {
        const schemaFields = {
            ...
            chatDisplay: new fields.BooleanField({ initial: true, label: 'APP_EXAMPLE.ACTIONS.Config.displayInChat' }),
     ...
     */
    _getTags() {
        const tags = [game.i18n.localize(`APP_EXAMPLE.ACTIONS.TYPES.${this.type}.name`)];
