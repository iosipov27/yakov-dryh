    ...
    static defineSchema() {
        ...
        return {
            maxFear: new fields.NumberField({
                ...
                min: 0,
                initial: 12,
                label: 'APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.maxFear.label'
            }),
            maxHope: new fields.NumberField({
                ...
                min: 0,
                initial: 6,
                label: 'APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.maxHope.label'
            }),
            maxLoadout: new fields.NumberField({
                ...
                min: 0,
                initial: 5,
                label: 'APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.maxLoadout.label'
            }),
            maxDomains: new fields.NumberField({
                ...
                min: 1,
                initial: 2,
                label: 'APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.maxDomains.label'
            }),
            ...
            currency: new fields.SchemaField({
                title: new fields.StringField({
                    required: true,
                    initial: 'Gold',
                    label: 'APP_EXAMPLE.SETTINGS.Homebrew.currency.currencyName'
                }),
                coins: currencyField(
                    'Coins',
                    'APP_EXAMPLE.SETTINGS.Homebrew.currency.coinName',
                    'fa-solid fa-coin-front'
                ),
                handfuls: currencyField(
                    'Handfuls',
                    'APP_EXAMPLE.SETTINGS.Homebrew.currency.handfulName',
                    'fa-solid fa-coins'
                ),
                bags: currencyField('Bags', 'APP_EXAMPLE.SETTINGS.Homebrew.currency.bagName', 'fa-solid fa-sack'),
                chests: currencyField(
                    'Chests',
                    'APP_EXAMPLE.SETTINGS.Homebrew.currency.chestName',
            ...
            domains: new fields.TypedObjectField(
                new fields.SchemaField({
                    ...
                    label: new fields.StringField({ required: true, initial: '', label: 'APP_EXAMPLE.GENERAL.label' }),
            ...
            adversaryTypes: new fields.TypedObjectField(
                new fields.SchemaField({
                    id: new fields.StringField({ required: true }),
                    label: new fields.StringField({ required: true, label: 'APP_EXAMPLE.GENERAL.label' }),
    ...
    static defineSchema() {
        ...
        return {
            initial: new fields.NumberField({
                ...
                initial: 0,
                min: 0,
                label: 'APP_EXAMPLE.GENERAL.initial'
            }),
            max: new fields.NumberField({
                nullable: true,
                initial: null,
                min: 0,
                label: 'APP_EXAMPLE.GENERAL.max'
            }),
            label: new fields.StringField({ label: 'APP_EXAMPLE.GENERAL.label' }),
    ...
    new foundry.data.fields.SchemaField(
        {
            value: new foundry.data.fields.StringField({
                ...
                label: 'APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.resources.resources.value.label'
            }),
            isIcon: new foundry.data.fields.BooleanField({
                required: true,
                initial: true,
                label: 'APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.resources.resources.isIcon.label'
            }),
            noColorFilter: new foundry.data.fields.BooleanField({
                required: true,
                initial: false,
                label: 'APP_EXAMPLE.SETTINGS.Homebrew.FIELDS.resources.resources.noColorFilter.label'
            })
        },
        { required: true }
    );
