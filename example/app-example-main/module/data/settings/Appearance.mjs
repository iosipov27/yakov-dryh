export default class DhAppearance extends foundry.abstract.DataModel {
    static LOCALIZATION_PREFIXES = ['APP_EXAMPLE.SETTINGS.Appearance'];
        ...
        return {
            ...
            showTokenDistance: new StringField({
                ...
                choices: {
                    always: {
                        value: 'always',
                        label: 'APP_EXAMPLE.SETTINGS.Appearance.FIELDS.showTokenDistance.choices.always'
                    },
                    encounters: {
                        value: 'encounters',
                        label: 'APP_EXAMPLE.SETTINGS.Appearance.FIELDS.showTokenDistance.choices.encounters'
                    },
                    never: {
                        value: 'never',
                        label: 'APP_EXAMPLE.SETTINGS.Appearance.FIELDS.showTokenDistance.choices.never'
                    }
                },
                nullable: false,
                initial: 'always'
