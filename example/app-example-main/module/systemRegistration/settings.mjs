...
export const registerDHSettings = () => {
    ...
    game.settings.register(CONFIG.DH.id, CONFIG.DH.SETTINGS.gameSettings.SpotlightRequestQueue, {
        name: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.SpotlightRequestQueue.name'),
        label: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.SpotlightRequestQueue.label'),
        hint: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.SpotlightRequestQueue.hint'),
        scope: 'world',
        config: true,
        type: Boolean,
...
const registerMenus = () => {
    game.settings.registerMenu(CONFIG.DH.id, CONFIG.DH.SETTINGS.menu.Automation.Name, {
        name: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.automation.name'),
        label: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.automation.label'),
        hint: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.automation.hint'),
    ...
    game.settings.registerMenu(CONFIG.DH.id, CONFIG.DH.SETTINGS.menu.Metagaming.Name, {
        name: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.metagaming.name'),
        label: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.metagaming.label'),
        hint: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.metagaming.hint'),
    ...
    game.settings.registerMenu(CONFIG.DH.id, CONFIG.DH.SETTINGS.menu.Homebrew.Name, {
        name: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.homebrew.name'),
        label: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.homebrew.label'),
        hint: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.homebrew.hint'),
    ...
    game.settings.registerMenu(CONFIG.DH.id, CONFIG.DH.SETTINGS.gameSettings.appearance, {
        name: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.appearance.label'),
        label: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.appearance.label'),
        hint: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.appearance.hint'),
    ...
    game.settings.registerMenu(CONFIG.DH.id, CONFIG.DH.SETTINGS.menu.VariantRules.Name, {
        name: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.variantRules.title'),
        label: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.variantRules.label'),
        hint: game.i18n.localize('APP_EXAMPLE.SETTINGS.Menu.variantRules.hint'),
...
const registerNonConfigSettings = () => {
    ...
    game.settings.register(CONFIG.DH.id, CONFIG.DH.SETTINGS.gameSettings.Resources.Fear, {
        name: game.i18n.localize('APP_EXAMPLE.SETTINGS.Resources.fear.name'),
        hint: game.i18n.localize('APP_EXAMPLE.SETTINGS.Resources.fear.hint'),
        scope: 'world',
        config: false,
        type: Number,
        default: 0,
