export default class DhMeasuredTemplate extends foundry.canvas.placeables.MeasuredTemplate {
    ...
    static getRangeLabels(distanceValue, settings) {
        ...
        const sceneRangeMeasurement = canvas.scene.flags["app-example"]?.rangeMeasurement;
        ...
        result.distance = game.i18n.localize(`APP_EXAMPLE.CONFIG.Range.${distanceKey ?? 'veryFar'}.name`);
        return result;
    }
}
